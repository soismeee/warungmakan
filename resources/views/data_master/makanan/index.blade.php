...
@section('container')
        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">Makanan</h4>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="mt-4">
                                        <button class="btn btn-info waves-effect waves-light" style="display: none" id="update-makanan">Ubah Makanan</button>
                                        <button class="btn btn-primary waves-effect waves-light" id="add-makanan">Tambah Makanan</button>
                                    </div>
    ...
    $(document).on('click', '#add-makanan', function(e){
        e.preventDefault();
    ...
    $(document).on('click', '#update-makanan', function(e){
        e.preventDefault();
    ...
    $(document).on('click', '#deleted', function(e){
        ...
        $.ajax({
            ...
            success: function (response){
                ...
                $('.success_message').addClass('alert alert-success');
                $('.success_message').html('Data makanan berhasil dihapus <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true"><i class="mdi mdi-close"></i></span></button>');
                $('#data-table').DataTable().ajax.reload();
            }
        });
    });
